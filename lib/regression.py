...
class Reg_Lib:
    ...
    _versions_1 = ["v1_instance_1", "v1_instance_2", "v1_instance_3", "v1_instance_4", "v1_instance_5",
                   "v1_instance_6", "v1_instance_7", "v1_instance_8", "v1_instance_9", "v1_instance_10"]
    _versions_2 = ["v2_instance_1", "v2_instance_2", "v2_instance_3", "v2_instance_4", "v2_instance_5",
                   "v2_instance_6", "v2_instance_7", "v2_instance_8", "v2_instance_9", "v2_instance_10"]
...
#---------------------------VERSION 1 RUN & COMPILE TEST CASES ---------------------------------#
    ...
    def run_v1(self):
        for v in Reg_Lib._versions_1:
            ...
            self.write_file(Reg_Lib._test_dir+"/"+v+"/" +
                            Reg_Lib._output_dir+"/"+Reg_Lib._stdout_file, shell_out)
    """
