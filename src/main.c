...
int main ( int argc, char *argv[] )
{
    ...
    /* --- CPU & HEAP PROFILE START
        HeapProfilerStart("heap.hprof");
    ...
    */
    ...
    rinit(con.seed);
    printf("Parameters are rho=%f, L=%d, seed=%d, max_clusters = %d\n", con.rho, con.L, con.seed, con.max_clusters);
    /*==========================ALLOCATIONS===============================================================*/
    ...
    /* --- CPU & HEAP PROFILE END
        ProfilerStop();
        HeapProfilerDump("heap.hprof");
        HeapProfilerStop();
    */
